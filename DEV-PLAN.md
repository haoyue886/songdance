...
- Petzold 修正使 10 段真人回归与 16 段结构回归的既有指纹按预期失效；当前 API 全量为 362 passed、6 skipped、6 failed，6 项均为 fail-closed 指纹门禁。必须重新生成两套回归产物、完成解析校验与人工复评，不能直接修改 fingerprint，也不能把本次 WIP 检查点宣称为 Phase 完成。
