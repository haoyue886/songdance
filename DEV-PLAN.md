...
- 10 段真人钢琴集与 16 段结构集已按 `simple-arpeggio-filter-v8` 与可审计倍频跟踪阈值重生成并绑定对应指纹：真人集指纹 `4d7b11d60d5f5446cc97f17c5189aa8d17590e8f196e920a2298a80e173e6a15`，结构集指纹 `2065d538e23d4829c245e1b45c7027ba5a66111c7a7a7bbed1d0b7cb4a5eae6d`。26 份 MusicXML 的 music21、`xmllint`、OSMD 共 78 项全部通过；两套人工评级均重置为 `pending`。离线包为 `songdance/api/dist/songdance-structure-review-2065d538e23d.zip`，SHA-256 `3fa1178bcee4efa0ef8b067cedd83ce7d06c38ed8bbe4a2172eb637a2bf6dba2`，`unzip -t` 通过。最终自动门禁为 API `395 passed/6 skipped`、Web `140 passed`、TypeScript、ESLint、Ruff、Next.js 45 页面生产构建和 Playwright `26 passed`。E2E 使用高于用例数量的小时/日测试配额隔离跨用例计数，同时保留单客户端活动任务上限的 429 专项验证。
