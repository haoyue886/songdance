...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: t("metaTitle"), description: t("metaDescription"), alternates: localeAlternates(locale, "/terms"), openGraph: { url: localePath(locale, "/terms"), title: t("metaTitle"), description: t("metaDescription") } };
}
